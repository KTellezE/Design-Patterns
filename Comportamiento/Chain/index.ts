...
const matrialValidator = new MaterialAvailabilityValidator()
...
studentValidator.setNext(matrialValidator).setNext(courseValidator)
try {
    ...
    console.error('Fallo uno de los validadores...')
    console.error(error)   
}
